...
import com.vitaliyhtc.accelerometerfirebase.models.FileInfoOnDevice;
import com.vitaliyhtc.accelerometerfirebase.models.FileInfoOnStorage;
import com.vitaliyhtc.accelerometerfirebase.models.FileStoreUploadedFiles;
import com.vitaliyhtc.accelerometerfirebase.models.ProgressItem;
import com.vitaliyhtc.accelerometerfirebase.models.TaskListeners;
 ...
 * see: http://stackoverflow.com/questions/43355928/resuming-uploadtask-results-in-e-storageexception-bufferedinputstream-is-closed
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                intent = new Intent(FileStoreActivity.this, TaskChooserActivity.class);
    ...
    private void initVariables() {
        ...
        mDatabaseReference = FirebaseUtils.getCurrentUserDatabaseRefFiles();
    ...
    private void initFileList() {
        ...
        mFirebaseAdapter = new FileInfoOnStorageAdapter(
                ...
                FileInfoOnStorageAdapter.FileInfoOnStorageViewHolder.class,
                mDatabaseReference.child(DATABASE_REFERENCE_FILE_LIST_NAME));

        mFirebaseAdapter.setDownloadClickListener(new FileInfoOnStorageAdapter.FileInfoOnStorageViewHolder.DownloadClickListener() {
            @Override
            public void onItemClickDownload(int position) {
                actionDownloadFile(mFirebaseAdapter.getItem(position));
            }
        });
        mFirebaseAdapter.setDeleteClickListener(new FileInfoOnStorageAdapter.FileInfoOnStorageViewHolder.DeleteClickListener() {
            @Override
